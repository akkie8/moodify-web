...
export default function CompanyInfo() {
  return (
    <div className='container mx-auto flex flex-col justify-center px-4 py-16 text-center'>
      ...
      <h2 className='mb-2 text-lg font-semibold  md:mb-4 md:text-3xl'>サービス名</h2>
      <p className='mb-4 text-sm md:text-xl'>Moodify</p>

      <h2 className='mb-2 text-lg font-semibold md:mb-4 md:text-3xl'>運営者</h2>
      <p className='mb-4 text-sm md:text-xl'>山田 亜樹（個人事業主）</p>

      <h2 className='mb-2 text-lg font-semibold md:mb-4 md:text-3xl'>事業内容</h2>
      ...
      <h2 className='mb-2 text-lg font-semibold md:mb-4 md:text-3xl'>連絡先</h2>
      <p className='mb-4 text-sm md:text-xl'>
