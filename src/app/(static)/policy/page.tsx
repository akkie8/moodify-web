...
export default function PrivacyPolicy() {
  return (
    <div className='container max-w-md mx-0 px-4 py-10 tracking-widest leading-6 text-sm md:max-w-xl md:mx-auto'>
      ...
      <h2 className='p-2 mb-4 text-base bg-gray-100'>1. 収集する情報</h2>
      <p className='mb-4'>
      ...
      <h2 className='p-2 mb-4 text-base bg-gray-100'>2. 情報の利用目的</h2>
      <p className='mb-4'>
        収集した情報は、サービスの提供・改善、ユーザーサポート、統計データの作成に利用します。
      </p>
      <h2 className='p-2 mb-4 text-base bg-gray-100'>3. 情報の管理</h2>
      <p className='mb-4'>
        当サービスは、ユーザーの個人情報を適切に管理し、不正アクセス、紛失、破壊、改ざん、漏洩などを防ぐため、セキュリティ対策を実施します。
      </p>
      <h2 className='p-2 mb-4 text-base bg-gray-100'>4. 第三者への提供</h2>
      <p className='mb-4'>
        法令に基づく場合を除き、ユーザーの同意なく第三者に個人情報を提供することはありません。
      </p>
      <h2 className='p-2 mb-4 text-base bg-gray-100'>5. プライバシーポリシーの変更</h2>
      <p className='mb-4'>
