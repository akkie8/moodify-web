...
export default function TermsOfService() {
  return (
    <div className='container max-w-md mx-0 px-4 py-10 text-sm md:max-w-xl md:mx-auto'>
      <h1 className='mb-8 tracking-widest text-base font-medium md:text-center'>利用規約</h1>
      <p className='mb-4 leading-6'>
        この利用規約（以下、「本規約」）は、Moodify（以下、「当サービス」）の利用条件を定めるものです。
      </p>
      <h2 className='p-2 mb-4 tracking-widest text-base bg-gray-100'>1. 適用</h2>
      <p className='mb-4 leading-6'>
        本規約は、ユーザーと当サービスとの間の本サービスの利用に関わる一切の関係に適用されるものとします。
      </p>
      <h2 className='p-2 mb-4 tracking-widest text-base bg-gray-100'>2. 利用登録</h2>
      <p className='mb-4 leading-6'>
        登録希望者が当サービスの定める方法によって利用登録を申請し、当サービスがこれを承認することによって、利用登録が完了するものとします。
      </p>
      <h2 className='p-2 mb-4 tracking-widest text-base bg-gray-100'>3. ユーザーの責任</h2>
      <p className='mb-4 leading-6'>
        ユーザーは、自己の責任において、本サービスを利用するものとし、本サービスの利用によって生じた一切の結果について責任を負うものとします。
      </p>
      <h2 className='p-2 mb-4 tracking-widest text-base bg-gray-100'>4. 禁止事項</h2>
      <p className='mb-4 leading-6'>
      ...
      <h2 className='p-2 mb-4 tracking-widest text-base bg-gray-100'>5. サービス内容の変更等</h2>
      <p className='mb-4 leading-6'>
